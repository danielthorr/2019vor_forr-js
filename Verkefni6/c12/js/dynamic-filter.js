(function() {
  ...
  /* 
  let rows = [];                                  // rows array
  let min = document.getElementById("value-min"); // Minimum text input
  let max = document.getElementById("value-max"); // Maximum text input
  let table = document.getElementById("rates");   // The table that shows results
  */
  ...
  function init() {                     // Tasks when script first runs
    ...
    // Athuga hvort þetta gefi mér einhverja fleiri möguleika með slider
    let slider = $("#slider").noUiSlider({           // Set up the slide control
